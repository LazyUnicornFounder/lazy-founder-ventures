  ...
  return (
    <div className="h-screen w-full flex flex-col bg-background overflow-hidden">
      ...
      <header className="relative flex flex-col items-center py-8 border-b-2 border-border shrink-0">
        ...
        <span
          className="text-foreground/70 text-xs lg:text-sm tracking-[0.4em] uppercase mt-2 font-bold"
          style={{ fontFamily: "var(--font-display)" }}
        >
          Accelerate autonomous capitalism
        </span>
        <div className="absolute right-6 lg:right-10 top-1/2 -translate-y-1/2 flex items-center gap-4">
          <a
